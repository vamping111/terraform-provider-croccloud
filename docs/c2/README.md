...
- [Публикация провайдера в private terraform registry](#публикация-провайдера-в-private-terraform-registry)
    ...
    - [Загрузка новой версии](#загрузка-новой-версии)
        ...
        - [Использование автоматизации Github Actions](#использование-автоматизации-github-actions)
...
Так же можно запустить unit тесты с помощью проставления лейбла `need_unit` в PR'е
...
Так же линтеры для документации можно запустить с помощью проставления лейбла `doc_linters` в PR'е
...
1) github token с правами public_repo -  AUTOMATION_PAT
2) Приватный ключ GPG(без пароля) -  GPG_PRIVATE_KEY
